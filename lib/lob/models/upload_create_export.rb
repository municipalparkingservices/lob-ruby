  ...
  class UploadCreateExport
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Lob::UploadCreateExport` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Lob::UploadCreateExport`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @export_id.nil?
        invalid_properties.push('invalid value for "export_id", export_id cannot be nil.')
      end
    ...
    def valid?
      ...
      message_validator = EnumAttributeValidator.new('String', ["Export is processing."])
      return false unless message_validator.valid?(@message)
      return false if @export_id.nil?
      true
    end
    ...
    def message=(message)
      validator = EnumAttributeValidator.new('String', ["Export is processing."])
