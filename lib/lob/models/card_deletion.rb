...
module Lob
  ...
  class CardDeletion
    ...
    def valid?
      return false if !@id.nil? && @id !~ Regexp.new(/^card_[a-zA-Z0-9]+$/)
      object_validator = EnumAttributeValidator.new('String', ["card_deleted"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["card_deleted"])
