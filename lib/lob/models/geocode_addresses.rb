...
module Lob
  class GeocodeAddresses
    ...
    attr_accessor :location_analysis
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'location_analysis')
        self.location_analysis = attributes[:'location_analysis']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          location_analysis == o.location_analysis
    end
    ...
    def hash
      [components, location_analysis].hash
    end
