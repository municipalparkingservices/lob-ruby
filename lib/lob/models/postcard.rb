...
module Lob
  class Postcard
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'front_template_id')
        self.front_template_id = attributes[:'front_template_id']
      end

      if attributes.key?(:'back_template_id')
        self.back_template_id = attributes[:'back_template_id']
      end

      if attributes.key?(:'front_template_version_id')
        self.front_template_version_id = attributes[:'front_template_version_id']
      end

      if attributes.key?(:'back_template_version_id')
        self.back_template_version_id = attributes[:'back_template_version_id']
      end
    ...
    def list_invalid_properties
      ...
      if !@front_template_id.nil? && @front_template_id !~ pattern
        invalid_properties.push("invalid value for \"front_template_id\", must conform to the pattern #{pattern}.")
      end

      pattern = Regexp.new(/^tmpl_[a-zA-Z0-9]+$/)
      if !@back_template_id.nil? && @back_template_id !~ pattern
        invalid_properties.push("invalid value for \"back_template_id\", must conform to the pattern #{pattern}.")
      end

      pattern = Regexp.new(/^vrsn_[a-zA-Z0-9]+$/)
      if !@front_template_version_id.nil? && @front_template_version_id !~ pattern
        invalid_properties.push("invalid value for \"front_template_version_id\", must conform to the pattern #{pattern}.")
      end

      pattern = Regexp.new(/^vrsn_[a-zA-Z0-9]+$/)
      if !@back_template_version_id.nil? && @back_template_version_id !~ pattern
        invalid_properties.push("invalid value for \"back_template_version_id\", must conform to the pattern #{pattern}.")
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] front_template_id Value to be assigned
    ...
    # Custom attribute writer method with validation
    # @param [Object] back_template_id Value to be assigned
    def back_template_id=(back_template_id)
      pattern = Regexp.new(/^tmpl_[a-zA-Z0-9]+$/)
      if !back_template_id.nil? && back_template_id !~ pattern
        fail ArgumentError, "invalid value for \"back_template_id\", must conform to the pattern #{pattern}."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] front_template_version_id Value to be assigned
    def front_template_version_id=(front_template_version_id)
      pattern = Regexp.new(/^vrsn_[a-zA-Z0-9]+$/)
      if !front_template_version_id.nil? && front_template_version_id !~ pattern
        fail ArgumentError, "invalid value for \"front_template_version_id\", must conform to the pattern #{pattern}."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] back_template_version_id Value to be assigned
    def back_template_version_id=(back_template_version_id)
      pattern = Regexp.new(/^vrsn_[a-zA-Z0-9]+$/)
      if !back_template_version_id.nil? && back_template_version_id !~ pattern
        fail ArgumentError, "invalid value for \"back_template_version_id\", must conform to the pattern #{pattern}."
      end
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["postcard"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deleted == o.deleted &&
          front_template_id == o.front_template_id &&
          back_template_id == o.back_template_id &&
          front_template_version_id == o.front_template_version_id &&
          back_template_version_id == o.back_template_version_id &&
