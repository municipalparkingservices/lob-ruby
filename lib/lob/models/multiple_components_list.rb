  ...
  class MultipleComponentsList
    ...
    def list_invalid_properties
      ...
      if @addresses.length > 20
        invalid_properties.push('invalid value for "addresses", number of items must be less than or equal to 20.')
      end
    ...
    def valid?
      ...
      return false if @addresses.length > 20
    ...
    def addresses=(addresses)
      ...
      if addresses.length > 20
        fail ArgumentError, 'invalid value for "addresses", number of items must be less than or equal to 20.'
      end
