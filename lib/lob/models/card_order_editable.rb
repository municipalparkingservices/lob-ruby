...
module Lob
  class CardOrderEditable
    ...
    def list_invalid_properties
      ...
      if @quantity < 10000
        invalid_properties.push('invalid value for "quantity", must be greater than or equal to 10000.')
      end
    ...
    def valid?
      ...
      return false if @quantity < 10000
      true
    end
    ...
    def quantity=(quantity)
      ...
      if quantity < 10000
        fail ArgumentError, 'invalid value for "quantity", must be greater than or equal to 10000.'
      end
