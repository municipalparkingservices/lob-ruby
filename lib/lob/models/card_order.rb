...
module Lob
  class CardOrder
    ...
    def list_invalid_properties
      ...
      pattern = Regexp.new(/^co_[a-zA-Z0-9]+$/)
    ...
    def valid?
      return false if !@id.nil? && @id !~ Regexp.new(/^co_[a-zA-Z0-9]+$/)
      return false if !@card_id.nil? && @card_id !~ Regexp.new(/^card_[a-zA-Z0-9]+$/)
    ...
    def hash
      [id, card_id, status, inventory, quantity_ordered, unit_price, cancelled_reason, availability_date, expected_availability_date, date_created, date_modified, deleted, object].hash
    end
