...
module Lob
  ...
  class LetterDeletion
    ...
    def valid?
      return false if !@id.nil? && @id !~ Regexp.new(/^ltr_[a-zA-Z0-9]+$/)
      object_validator = EnumAttributeValidator.new('String', ["letter_deleted"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["letter_deleted"])
