...
module Lob
  class PlaceholderModel
    ...
    attr_accessor :address_domestic

    attr_accessor :letter_details_writable

    attr_accessor :postcard_details_writable

    attr_accessor :letter_details_returned

    attr_accessor :postcard_details_returned
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'address_domestic')
        self.address_domestic = attributes[:'address_domestic']
      end

      if attributes.key?(:'letter_details_writable')
        self.letter_details_writable = attributes[:'letter_details_writable']
      end

      if attributes.key?(:'postcard_details_writable')
        self.postcard_details_writable = attributes[:'postcard_details_writable']
      end

      if attributes.key?(:'letter_details_returned')
        self.letter_details_returned = attributes[:'letter_details_returned']
      end

      if attributes.key?(:'postcard_details_returned')
        self.postcard_details_returned = attributes[:'postcard_details_returned']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          address_domestic == o.address_domestic &&
          letter_details_writable == o.letter_details_writable &&
          postcard_details_writable == o.postcard_details_writable &&
          letter_details_returned == o.letter_details_returned &&
          postcard_details_returned == o.postcard_details_returned
    end
    ...
    def hash
      [return_envelope, address_domestic, letter_details_writable, postcard_details_writable, letter_details_returned, postcard_details_returned].hash
    end
