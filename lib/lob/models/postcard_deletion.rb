...
module Lob
  ...
  class PostcardDeletion
    ...
    def valid?
      return false if !@id.nil? && @id !~ Regexp.new(/^psc_[a-zA-Z0-9]+$/)
      object_validator = EnumAttributeValidator.new('String', ["postcard_deleted"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["postcard_deleted"])
