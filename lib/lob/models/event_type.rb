...
module Lob
  class EventType
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'enabled_for_test')
        self.enabled_for_test = attributes[:'enabled_for_test']
      end
    ...
    def list_invalid_properties
      ...
      if @enabled_for_test.nil?
        invalid_properties.push('invalid value for "enabled_for_test", enabled_for_test cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @enabled_for_test.nil?
      return false if @resource.nil?
      resource_validator = EnumAttributeValidator.new('String', ["postcards", "self mailers", "letters", "checks", "addresses", "bank accounts"])
      return false unless resource_validator.valid?(@resource)
      return false if @object.nil?
      object_validator = EnumAttributeValidator.new('String', ["event_type"])
    ...
    def resource=(resource)
      validator = EnumAttributeValidator.new('String', ["postcards", "self mailers", "letters", "checks", "addresses", "bank accounts"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["event_type"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          enabled_for_test == o.enabled_for_test &&
          resource == o.resource &&
          object == o.object
    end
    ...
    def hash
      [id, enabled_for_test, resource, object].hash
    end
