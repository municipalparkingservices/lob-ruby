  ...
  class SelfMailerDeletion
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'object')
        ...
        self.object = 'self_mailer_deleted'
      end
    end
    ...
    def valid?
      return false if !@id.nil? && @id !~ Regexp.new(/^sfm_[a-zA-Z0-9]+$/)
      object_validator = EnumAttributeValidator.new('String', ["self_mailer_deleted"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["self_mailer_deleted"])
