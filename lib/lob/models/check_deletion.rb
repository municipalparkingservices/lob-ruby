...
module Lob
  ...
  class CheckDeletion
    ...
    def valid?
      return false if !@id.nil? && @id !~ Regexp.new(/^chk_[a-zA-Z0-9]+$/)
      object_validator = EnumAttributeValidator.new('String', ["check_deleted"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["check_deleted"])
