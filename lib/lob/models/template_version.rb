...
module Lob
  class TemplateVersion
    ...
    attr_accessor :suggest_json_editor
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Lob::TemplateVersion` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Lob::TemplateVersion`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'suggest_json_editor')
        self.suggest_json_editor = attributes[:'suggest_json_editor']
      end
    ...
    def list_invalid_properties
      ...
      if @html.to_s.length > 100000
        invalid_properties.push('invalid value for "html", the character length must be smaller than or equal to 100000.')
      end
    ...
    def valid?
      ...
      return false if @id !~ Regexp.new(/^vrsn_[a-zA-Z0-9]+$/)
      return false if !@description.nil? && @description.to_s.length > 255
      return false if @html.nil?
      return false if @html.to_s.length > 100000
      object_validator = EnumAttributeValidator.new('String', ["version"])
    ...
    def html=(html)
      ...
      if html.to_s.length > 100000
        fail ArgumentError, 'invalid value for "html", the character length must be smaller than or equal to 100000.'
      end
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["version"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          html == o.html &&
          engine == o.engine &&
          suggest_json_editor == o.suggest_json_editor &&
    ...
    def hash
      [id, description, html, engine, suggest_json_editor, merge_variables, date_created, date_modified, deleted, object].hash
    end
