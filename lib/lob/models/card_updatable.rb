...
module Lob
  class CardUpdatable
    ...
    def list_invalid_properties
      ...
      if !@reorder_quantity.nil? && @reorder_quantity < 10000
        invalid_properties.push('invalid value for "reorder_quantity", must be greater than or equal to 10000.')
      end
    ...
    def valid?
      ...
      return false if !@reorder_quantity.nil? && @reorder_quantity < 10000
      true
    end
    ...
    def reorder_quantity=(reorder_quantity)
      ...
      if !reorder_quantity.nil? && reorder_quantity < 10000
        fail ArgumentError, 'invalid value for "reorder_quantity", must be greater than or equal to 10000.'
      end
