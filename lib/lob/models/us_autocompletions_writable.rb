...
module Lob
  class UsAutocompletionsWritable
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'address_prefix')
        self.address_prefix = attributes[:'address_prefix']
      end
      ...
      if attributes.key?(:'geo_ip_sort')
        self.geo_ip_sort = attributes[:'geo_ip_sort']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @address_prefix.nil?
        invalid_properties.push('invalid value for "address_prefix", address_prefix cannot be nil.')
      end
    ...
    def valid?
      return false if @address_prefix.nil?
      true
    end
    ...
    def hash
      [address_prefix, city, state, zip_code, geo_ip_sort].hash
    end
