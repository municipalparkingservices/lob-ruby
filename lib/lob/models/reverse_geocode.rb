  ...
  class ReverseGeocode
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'object')
        ...
        self.object = 'us_reverse_geocode_lookup'
      end
    end
    ...
    def list_invalid_properties
      ...
      pattern = Regexp.new(/^us_reverse_geocode_[a-zA-Z0-9_]+$/)
    ...
    def valid?
      return false if !@id.nil? && @id !~ Regexp.new(/^us_reverse_geocode_[a-zA-Z0-9_]+$/)
      object_validator = EnumAttributeValidator.new('String', ["us_reverse_geocode_lookup"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["us_reverse_geocode_lookup"])
